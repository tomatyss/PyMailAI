...
class GmailCredentials:
    ...
    def __init__(self, credentials_path: Union[str, Path]):
        ...
        self._credentials: Dict = self._load_credentials()
    ...
    @classmethod
    def from_oauth_credentials(cls, 
                             client_id: str,
                             client_secret: str,
                             refresh_token: str,
                             token_uri: str = "https://oauth2.googleapis.com/token",
                             save_path: Optional[Union[str, Path]] = None) -> "GmailCredentials":
    ...
    def to_email_config(self, email_address: str) -> EmailConfig:
        ...
        return EmailConfig(
            email=email_address,
            password=self._credentials.get("refresh_token", ""),  # Use refresh token as password
